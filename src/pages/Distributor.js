...
const Distributor = ({ account,app, setApp }) => {
  ...
  async function transferToRetail() {
    setSending(true);
    ...
    try {
      await contract
        .itemToRetail(itemIdBig, retIdBig, distributorIdBig)
        .then((response) => {
          toast
              ...
              <div className="col-sm-12 form-column">
                <form action="success" method="post">
                  ...
                  {sending ? (
                      ...
                      <Button className="text-white" onClick={transferToRetail}>
                        Transfer
                      </Button>
                    )}
                  </form>
